...
public class MainWindow extends JFrame {
    ...
    private void addMenuBar() {
        ...
        licenceItem.addActionListener(a -> LicenseDialog.getInstance().setVisible(true));
        help.add(licenceItem);

        JMenuItem aboutItem = new JMenuItem("About");
        aboutItem.addActionListener(a -> AboutDialog.getInstance().setVisible(true));
        help.add(aboutItem);

        JMenuItem usedLibraries = new JMenuItem("Used Libraries");
        usedLibraries.addActionListener(a -> LibrariesDialog.getInstance().setVisible(true));
